        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="attendance-form">
                    ...
                    <hr>
                    <div class="row">
                        <div class="col-md-6" id="doctor-selection"><?= $form->field($model, 'Lawyer')->multiselect($iconsLawyer, ['selector' => 'radio']); ?></div>
                    ...
                    <div class="form-group">
                        <?= Html::a('Cancel', ['lawyer/index'], ['class' => 'btn btn-warning']) ?>        
