        ...
        [
            ...
            'buttons' => [
                'today_action' => function ($url, $model) {
                    return Html::a('<span class="glyphicon glyphicon-pushpin edit-today"></span>', $url, [
            ...
            GridView::widget([
                ...
                'beforeHeader' => [
                    [
                        'columns' => [
                            ['content' => 'Customer\'s Details', 'options' => ['colspan' => 6, 'class' => 'text-center warning']],
                            ['content' => 'Today\'s Dropin', 'options' => ['colspan' => 4, 'class' => 'text-center success']],
                            ['content' => 'Custommer\'s Comments', 'options' => ['colspan' => 3, 'class' => 'text-center warning']],
                            ['content' => 'Editing Custommer\'s', 'options' => ['colspan' => 2, 'class' => 'text-center warning']],
                        ],
                ...
                'hover' => true,
                'panel' => [
                    'heading' => '<h3 class="panel-title"><i class="glyphicon glyphicon-user"></i> List of customers - ' . $this->title . '</h3>',
                    'type' => 'primary',
                    'showFooter' => false
                ],
                'columns' => $gridColumns,
                ...
                'toolbar' => [
                    ['content' =>
                        Html::a('<i class="glyphicon glyphicon-plus"></i>  Create new Customer', ['create'], ['class' => 'btn btn-success']),
                    ],
                    '{export}',
                ],
            ]);
