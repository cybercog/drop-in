...
//                ['label' => 'Contact', 'url' => ['/site/contact']],
            ...
            if (Yii::$app->hasModule('user')) {
                if (Yii::$app->user->isGuest) {
                    ...
                    $menuItems = [
                        ['label' => 'Customers Dropin', 'url' => ['/customers/index']],
                        ...
                        ['label' => 'Utilities', 'items' => [
                                ...
                                ['label' => 'Testing Sync', 'url' => ['/utilities/index']],
                            ]],
                    ];
                    $menuItems[] = [
...
<?= Html::a('About', ['/site/about']) ?>
                ...
                <p class="pull-left"><?=
                    Html::a(
                            Html::img('media/powered-by-open-ecommerce-org.png', ['alt' => 'developed by open-ecommerce']), '#', ['data-toggle' => 'modal', 'data-target' => '#infoModal']
                    )
                    ?></p>
            </div>
        </footer>
